...
<head>
    <meta charset="UTF-8">
    <title>Área Particular - TechFit</title>
    <link rel="stylesheet" href="styleparticular.css">
</head>
<body>
    <header class="topo">
        <div class="logo">
        ...
        <nav>
          <div class="atalhos-btns">
                <a href="treinadoress.php" class="btn">Treinadores</a>
  ...
            </div>
    ...
    <main>
        <section class="boas-vindas">
            <h1>Bem-vindo(a) à sua área particular<span class="destaque"></span>!</h1>
